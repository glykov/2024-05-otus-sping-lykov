...
public class ResultServiceImpl implements ResultService {
    ...
    public void showResult(TestResult testResult) {
        ...
        ioService.printFormattedLine("Right answers count: %d", testResult.getRightAnswerCount());

        if (testResult.getRightAnswerCount() >= testConfig.getRightAnswersCountToPass()) {
